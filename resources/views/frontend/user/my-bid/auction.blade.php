<div class="col-lg-4 col-md-6 mt-3">
    <div class="new-mzad">
        ...
        <p class="top-offer"><span class="ub-font">{{ $auction->auctionsUsers()->where('user_id',auth('user')->user()->id)->first()->price }}</span> @lang('app.currency')</p>
        <div class="new-box">
            <a href="{{ route('frontend.auctions.show',$auction->slug) }}">
                <h3>{{ $auction->name }}</h3>
            </a>
        ...
        <div class="box-detail">
            ...
            <div class="new-det-03 flex-fill"><p class="take">@lang('app.height_price')</p>
                <p class="price"><span class="ub-font">{{ $auction->highest_price }}</span> @lang('app.currency')</p>
            </div>
        </div>
    </div>
</div>
