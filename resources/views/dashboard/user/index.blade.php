                    ...
                    <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                        <div class="ag-btns d-flex flex-wrap">
                            <div class="btn-export">
                                <a class="btn btn-primary ag-grid-export-btn waves-effect waves-float waves-light" href="{{ route('admin.user.create') }}">@lang('app.create_new')</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page-script')
    ...
    @include('dashboard.panels.delete-popup',['routeName'=>'admin.user.destroy'])
@stop
