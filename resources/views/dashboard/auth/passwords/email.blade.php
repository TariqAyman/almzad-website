                ...
                <div class="card-body">
                    ...
                    <form class="auth-forgot-password-form mt-2" method="POST" action="{{ route('admin.password.email') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="forgot-password-email" name="email" value="{{ old('email') }}" placeholder="john@example.com" aria-describedby="forgot-password-email"
